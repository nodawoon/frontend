      ...
      {type === "gender" ? (
        ...
        <div className="h-10 flex space-x-6 justify-between items-center">
          <div className="flex items-center space-x-2">
            <input type="radio" value="남자" name="성별" />
            <label className="text-sm font-bold">남자</label>
          </div>
          <div className="flex items-center space-x-2">
            <input type="radio" value="여자" name="성별" />
        ...
        <div className="flex space-x-6 justify-between items-center">
          <div className="flex items-center space-x-2">
            <input type="radio" value="multiple_choice" name="question_type" />
            <label className="text-sm font-bold">객관식</label>
          </div>
          <div className="flex items-center space-x-2">
            <input type="radio" value="short_answer" name="question_type" />
            <label className="text-sm font-bold">단답형</label>
          </div>
          <div className="flex items-center space-x-2">
            <input type="radio" value="long_answer" name="question_type" />
